...
def get_common_transport(km_bus = "", km_coach = "", km_rail = "", km_int_rail = "", km_tram = "", km_sub = "", km_taxi = ""):
    ...
    headers = {
        ...
        'Referer': 'https://calculator.carbonfootprint.com/calculator.aspx?c=Full&tab=6&h=7ed100813a406a753c01546db353190e',
        'Cookie': 'CFp4Session=lkjefmvqwgbv1bnh3j1fxamk; CFp4CookieCheck=OK; __utma=86028682.149170279.1683794079.1683794079.1683801534.2; __utmc=86028682; __utmz=86028682.1683801534.2.2.utmcsr=google|utmccn=(organic)|utmcmd=organic|utmctr=(not%20provided); CFp3TextSize=0.8em; CFpAffiliate=RADsite; __utmb=86028682.1.10.1683801534; __utmt=1; CFp4CookieCheck=OK; CFp4Session=lkjefmvqwgbv1bnh3j1fxamk',
        'Upgrade-Insecure-Requests': '1',
